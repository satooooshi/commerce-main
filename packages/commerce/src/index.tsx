...
// CoreCommerceProvider:return <Commerce.Provider value={cfg}>{children}</Commerce.Provider>
// value={cfg}でuseContext(Commerce)で値を参照できるようになる
...
export function useCommerce<P extends Provider>() {
  console.log('export function useCommerce<P extends Provider>()')
  console.log(Commerce)
  console.log(useContext(Commerce))
